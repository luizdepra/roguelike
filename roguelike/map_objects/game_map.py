...
class GameMap:
        ...
        for i in range(number_of_items):
            ...
            if not any([e for e in entities if e.x == x and e.y == y]):
                ...
                if item_choice == "healing_potion":
                    ...
                    item = Entity(
                        x, y, "!", tcod.violet, "Healing Potion", render_order=RenderOrder.ITEM, item=item_component
                    )
                    ...
                    item = Entity(
                        x, y, "#", tcod.red, "Fireball Scroll", render_order=RenderOrder.ITEM, item=item_component
                    )
                    ...
                    item = Entity(
                        x, y, "#", tcod.yellow, "Lightning Scroll", render_order=RenderOrder.ITEM, item=item_component
                    )
    ...
    def next_floor(self, player, message_log, configs):
